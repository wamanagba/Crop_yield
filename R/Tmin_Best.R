...
# Exportation
library(here)
write.csv(seas_clim, here::here("data_output","Best_Temp_Min.csv"),row.names = FALSE )
save(seas_clim,file="data_output\\Best_Temp_Min.Rdata")

write.csv(mon_clim, here::here("data_output","Best_Temp_Min_month.csv"),row.names = FALSE )
save(mon_clim,file="data_output\\Best_Temp_Min_month.Rdata")
