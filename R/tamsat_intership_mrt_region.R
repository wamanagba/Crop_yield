...
#x=crop(S,extent(shp))
M=as.data.frame(t(extract(S,shp,mean,na.rm=T))) 
A=M
...
# Exportation
library(here)
write.csv(seas_clim, here::here("C:\\Users\\Yacou\\Desktop\\Yacouba_New\\Stage_Climate_Centre\\mrt\\","4_10_region.csv"),row.names = FALSE )

save(M,file="C:\\Users\\Yacou\\Desktop\\Yacouba_New\\Stage_Climate_Centre\\mrt\\region.Rdata")
