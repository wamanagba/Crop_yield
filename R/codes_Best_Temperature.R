...
##Inputs
basepath="C:/Users/Yacou/Desktop/Yacouba_New/climte/data/2-Temperature/BEST_Temperature_Berkeley Earth/nn/"
...
for (Index in c("TMIN","TMAX")){
  ...
  timedim=ncdim_def("time","days since 1970-01-01 00:00:00.0",(1:nrow(VAR))-1) 
