...
colnames(mon_clim)[3:46]=shp$NAME_2
...
# Exportation
library(here)
write.csv(seas_clim, here::here("C:\\Users\\Yacou\\Desktop\\Yacouba_New\\Stage_Climate_Centre\\mrt\\","mrt.csv"),row.names = FALSE )
...
write.csv(seas_clim, here::here("C:\\Users\\Yacou\\Desktop\\Yacouba_New\\Stage_Climate_Centre\\burk\\","chirps_Prec_year.csv"),row.names = FALSE )
save(B,file="C:\\Users\\Yacou\\Desktop\\Yacouba_New\\Stage_Climate_Centre\\burk\\Prec.Rdata")
