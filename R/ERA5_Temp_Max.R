...
#### Read Precip data
S= stack(paste0(basepath,"ERA5_Tmax.nc") )#S= crop(stack(paste0(basepath,"Tamsat_complet_Precipitation_Burkina.nc"), extent(shp)) )
#x=crop(S,extent(shp))
...
# Exportation
library(here)
write.csv(seas_clim, here::here("C:/Users/Yacou/Desktop/Yacouba_New/climte/Data/Temperature/ERA5/ok/data_output","ERA5_Tmax_Temp_year.csv"),row.names = FALSE )
save(seas_clim,file="C:/Users/Yacou/Desktop/Yacouba_New/climte/Data/Temperature/ERA5/ok/data_output/ERA5_Tmax_Temp_year.Rdata")

write.csv(mon_clim, here::here("C:/Users/Yacou/Desktop/Yacouba_New/climte/Data/Temperature/ERA5/ok/data_output","ERA5_Tmax_Temp_month.csv"),row.names = FALSE )
save(mon_clim,file="C:/Users/Yacou/Desktop/Yacouba_New/climte/Data/Temperature/ERA5/ok/data_output/ERA5_Tmax_Temp_month.Rdata")
