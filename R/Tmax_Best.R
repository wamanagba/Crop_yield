...
# Exportation
library(here)
write.csv(seas_clim, here::here("data_output","Best_Temp_Max_year.csv"),row.names = FALSE )
save(seas_clim,file="data_output\\Best_Temp_Max_year.Rdata")
View(seas_clim)


write.csv(mon_clim, here::here("data_output","Best_Temp_Max_month.csv"),row.names = FALSE )
save(mon_clim,file="data_output\\Best_Temp_Max_month.Rdata")
View(mon_clim)
